/**
 * Ported verbatim from: extensions/llamacpp-upstream-extension/src/chatTemplateOverrides.ts
...
export const STRICT_SYSTEM_GUARD_SIGNATURE = 'System message must be at the beginning'
...
export function resolveLlama3TemplateOverride(
  ...
  const looksLikeLlama3 = LLAMA3_MODEL_ID_RE.test(modelId) || embeddedTemplate.includes(LLAMA3_FORMAT_MARKER)
