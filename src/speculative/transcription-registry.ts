/**
 * Ported verbatim from: extensions/llamacpp-upstream-extension/src/transcriptionRegistry.ts
 * The voice model.
 *
...
export const TRANSCRIPTION_TOTAL_BYTES = TRANSCRIPTION_MODEL_BYTES + TRANSCRIPTION_MMPROJ_BYTES
 ...
 */
export const VOXTRAL_TRANSCRIPTION_CHAT_TEMPLATE = String.raw`{%- for message in messages %}
