/**
 * Ported verbatim from: extensions/llamacpp-upstream-extension/src/gemmaMtpRegistry.ts
...
const REGISTRY: readonly GemmaMtpRegistryEntry[] = [
  ...
  },
  {
    ...
    matches: (id) => id.includes('gemma') && id.includes('4') && id.includes('26b') && id.includes('a4b'),
    ...
    draftSha256: '918d48b5c219035561e0ff791f2926c939cd367d71ee21b002e99222bdecab8b',
    draftSize: 461766880,
  },
]
 ...
 */
export const GEMMA_MTP_DRAFT_FILENAMES: readonly string[] = REGISTRY.map((entry) => entry.draftFilename)
