/**
 * Ported verbatim from: extensions/llamacpp-upstream-extension/src/dflashRegistry.ts
...
const REGISTRY: readonly DflashRegistryEntry[] = [
  ...
  },
  {
    matches: (id) => {
      ...
      return compact.includes('qwen3coder') && compact.includes('30b') && compact.includes('a3b')
    },
    drafts: [
      atomicQ8Draft(
  ...
  {
    matches: (id) => isBaseQwen3(id) && compactId(id).includes('qwen38b'),
    drafts: [
      atomicQ8Draft(
  ...
  {
    matches: (id) => isBaseQwen3(id) && compactId(id).includes('qwen34b'),
    drafts: [
      atomicQ8Draft(
    ...
    drafts: [
      {
        ...
        draftSha256: 'd9999163059b9ae0e87b0f503d76451d922b5483c981d9afae250d82804b5f0d',
        draftSize: 765960384,
      },
      {
        quant: 'Q5_K_M',
        ...
        draftSha256: 'aa7521c7c210d1fd56e4e7520b6cbb5df6d0c7f813c8ddddff0861c4f8663045',
        draftSize: 913809600,
      },
      {
        quant: 'Q6_K',
        ...
        draftSha256: '4c9a1e123944e008ebc55677ba9d51a63dc81fcdb80e44a9a3e405e57563f8b0',
      ...
      },
      {
        ...
        draftSha256: '27b9d18e605aea9c50ef506e4b63921e0dc624cc91c63c60617a8295f153d436',
      ...
      },
      {
        ...
        draftSha256: '9c1f55bc887fc5efb565748580a6526a5c1ef9bdd1893002ccdca7be4d1213a5',
  ...
  },
  {
    ...
    matches: (id) => hasQwenFamily(id, '36') && id.includes('35b') && id.includes('a3b'),
    drafts: [
      {
        quant: 'IQ4_XS',
        repo: 'williamliao/Qwen3.6-35B-A3B-DFlash-GGUF',
        draftFilename: 'Qwen3.6-35B-A3B-DFlash-IQ4_XS.gguf',
        draftSha256: '13866fb2301f34cc31b5b8cda9ee1059bb7468ba5ef636be7e5e98d6fd371cdc',
        draftSize: 218030368,
      },
      {
        quant: 'Q4_K_M',
        ...
        draftSha256: '9f8a75a850d9e207ca8a8de2cfa691aef61c63895d224defc00abfc34d5779bd',
        draftSize: 235692320,
      },
      {
        quant: 'Q5_K_M',
        ...
        draftSha256: '397df52ae2bb4afd88c1272a122001dc56ad2546153038aee468f6371b0045e9',
        draftSize: 280256800,
      },
      {
        quant: 'Q6_K',
        ...
        draftSha256: 'c1fe996a6f198c867b3d422b9bcf5c385f1dcc29b877628ccb2af1f9e278f649',
        draftSize: 327606560,
      },
      {
        quant: 'Q8_0',
        ...
        draftSha256: 'fc79ee2c84688674e4f134d5797a6baee4884167659a6eec8866c7789ee1318b',
        draftSize: 421060896,
      },
      {
        quant: 'F16',
        ...
        draftSha256: 'bd5385344d049ae9770972b9b694dfcc18005d7f4b9dfabde04f9b30ce21b631',
        draftSize: 782819616,
      },
    ],
  },
    ...
    drafts: [
      {
        ...
        draftSha256: '23861020ce5313567cb8e8fe56ce01b5f8e467df7d23ebecfe17fd19136f97d7',
        draftSize: 934435136,
      },
      {
        quant: 'Q4_K_M',
        ...
        draftSha256: '47901c650191c72a73a3d69e1f7cfa5744bce2bb46f82e6ebeaf729f90f5c3a3',
      ...
      },
      {
        ...
        draftSha256: 'ece22ee82e7a9acbd7b9617b4b252b029e3f3cd8a7a6a398362ebdd5b56b520f',
      ...
      },
      {
        ...
        draftSha256: 'ff4197923ce8d9c56f2dc745cfa95a1820d8d63a51aab66d4ad88d0827b6d8a4',
      ...
      },
      {
        ...
        draftSha256: 'b9be52167d0b4f5cbaffba6658bcb20dd814ad4e5846532353c165ccf97e47a1',
      ...
      },
      {
        ...
        draftSha256: '6bbbca1f2391ee5adf76e01ee9b7614787dbf0cecc5b67b45f5a20003915c081',
 ...
 */
export const DFLASH_DRAFT_FILENAMES: readonly string[] = REGISTRY.flatMap((entry) =>
  entry.drafts.map((draft) => draft.draftFilename)
)
...
export function resolveDflashDraft(modelId: string, quant = DEFAULT_DFLASH_DRAFT_QUANT): DflashDraft | null {
