/**
 * Ported verbatim from: extensions/mlx-extension/src/eagle3Registry.ts
 ...
 * calls happen here.
 */
import { type DraftRepoManifest, type DraftResolution, normalizeBaseId } from './mlx-dflash-registry.js'
